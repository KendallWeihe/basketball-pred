...
games = np.genfromtxt("/home/kendall/Development/basketball-db/spreads/{}.csv".format(sys.argv[1]), delimiter=",")

data_path = "/home/kendall/Development/basketball-db/tmp/{}/".format(sys.argv[1])
...
for game in games:
    ...
    try:
        ...
        if game_number == int(sys.argv[2]):
            game_number_count = game_number_count + 1
            os.system("python predict.py {} {} {} {} {} {} {} {} {} {} {}".format(game_number, team1_name, team2_name,game[0], \
            vegas_spread, sys.argv[3], sys.argv[4], sys.argv[5], sys.argv[6], sys.argv[7], sys.argv[1]))
...
print("Number of games equal to {}: {}".format(sys.argv[2], game_number_count))
